...
public class HOGDescriptor {
    ...
    public HOGDescriptor(Size _winSize, Size _blockSize, Size _blockStride, Size _cellSize,
        ...
        nativeObj = HOGDescriptor_1(_winSize.width, _winSize.height, _blockSize.width,
                _blockSize.height, _blockStride.width, _blockStride.height, _cellSize.width,
                _cellSize.height, _nbins, _derivAperture, _winSigma, _histogramNormType,
    ...
    public HOGDescriptor(Size _winSize, Size _blockSize, Size _blockStride, Size _cellSize,
        ...
        nativeObj = HOGDescriptor_2(_winSize.width, _winSize.height, _blockSize.width,
                _blockSize.height, _blockStride.width, _blockStride.height, _cellSize.width,
                _cellSize.height, _nbins);
    }
    ...
    private static native long HOGDescriptor_2(double _winSize_width, double _winSize_height,
            double _blockSize_width, double _blockSize_height, double _blockStride_width,
            double _blockStride_height, double _cellSize_width, double _cellSize_height,
            int _nbins);
    ...
    public void compute(Mat img, MatOfFloat descriptors, Size winStride, Size padding,
        ...
        compute_0(nativeObj, img.nativeObj, descriptors.nativeObj, winStride.width,
                winStride.height, padding.width, padding.height, locations.nativeObj);
    }
    ...
    public void detect(Mat img, MatOfPoint foundLocations, MatOfDouble weights, double hitThreshold,
        ...
        detect_0(nativeObj, img.nativeObj, foundLocations.nativeObj, weights.nativeObj,
                hitThreshold, winStride.width, winStride.height, padding.width, padding.height,
                searchLocations.nativeObj);
    }
    ...
    public void detectMultiScale(Mat img, MatOfRect foundLocations, MatOfDouble foundWeights,
            ...
            boolean useMeanshiftGrouping) {
        detectMultiScale_0(nativeObj, img.nativeObj, foundLocations.nativeObj,
                foundWeights.nativeObj, hitThreshold, winStride.width, winStride.height,
    ...
    public void detectMultiScale(Mat img, MatOfRect foundLocations, MatOfDouble foundWeights) {
        detectMultiScale_1(nativeObj, img.nativeObj, foundLocations.nativeObj,
                foundWeights.nativeObj);
    }
