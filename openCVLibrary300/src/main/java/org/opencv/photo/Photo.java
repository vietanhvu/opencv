...
public class Photo {
    ...
    public static void fastNlMeansDenoising(Mat src, Mat dst, MatOfFloat h, int templateWindowSize,
        ...
        fastNlMeansDenoising_0(src.nativeObj, dst.nativeObj, h.nativeObj, templateWindowSize,
    ...
    public static void fastNlMeansDenoising(Mat src, Mat dst, float h, int templateWindowSize,
        ...
        fastNlMeansDenoising_2(src.nativeObj, dst.nativeObj, h, templateWindowSize,
                searchWindowSize);
    }
    ...
    public static void fastNlMeansDenoisingMulti(List<Mat> srcImgs, Mat dst, int imgToDenoiseIndex,
            ...
            int normType) {
        Mat srcImgs_mat = Converters.vector_Mat_to_Mat(srcImgs);
        fastNlMeansDenoisingMulti_2(srcImgs_mat.nativeObj, dst.nativeObj, imgToDenoiseIndex,
                temporalWindowSize, h.nativeObj, templateWindowSize, searchWindowSize, normType);
    }
    ...
    public static void fastNlMeansDenoisingMulti(List<Mat> srcImgs, Mat dst, int imgToDenoiseIndex,
        ...
        Mat srcImgs_mat = Converters.vector_Mat_to_Mat(srcImgs);
        fastNlMeansDenoisingMulti_3(srcImgs_mat.nativeObj, dst.nativeObj, imgToDenoiseIndex,
                temporalWindowSize, h.nativeObj);
    }
    ...
    public static Tonemap createTonemap(float gamma) {
        ...
        return new Tonemap(createTonemap_0(gamma));
    }
    ...
    public static TonemapDrago createTonemapDrago(float gamma, float saturation, float bias) {
        ...
        return new TonemapDrago(createTonemapDrago_0(gamma, saturation, bias));
    }
    ...
    public static TonemapMantiuk createTonemapMantiuk(float gamma, float scale, float saturation) {
        ...
        return new TonemapMantiuk(createTonemapMantiuk_0(gamma, scale, saturation));
    }
    ...
    public static AlignMTB createAlignMTB(int max_bits, int exclude_range, boolean cut) {
        ...
        return new AlignMTB(createAlignMTB_0(max_bits, exclude_range, cut));
    }
    ...
    public static CalibrateDebevec createCalibrateDebevec(int samples, float lambda,
        ...
        return new CalibrateDebevec(createCalibrateDebevec_0(samples, lambda, random));
    }
    ...
    public static CalibrateRobertson createCalibrateRobertson(int max_iter, float threshold) {
        ...
        return new CalibrateRobertson(createCalibrateRobertson_0(max_iter, threshold));
    }
    ...
    public static void seamlessClone(Mat src, Mat dst, Mat mask, Point p, Mat blend, int flags) {
        ...
        seamlessClone_0(src.nativeObj, dst.nativeObj, mask.nativeObj, p.x, p.y, blend.nativeObj,
                flags);
    }
    ...
    public static void textureFlattening(Mat src, Mat mask, Mat dst, float low_threshold,
        ...
        textureFlattening_0(src.nativeObj, mask.nativeObj, dst.nativeObj, low_threshold,
    ...
    public static void pencilSketch(Mat src, Mat dst1, Mat dst2, float sigma_s, float sigma_r,
        ...
        pencilSketch_0(src.nativeObj, dst1.nativeObj, dst2.nativeObj, sigma_s, sigma_r,
                shade_factor);
    }
    ...
    private static native void fastNlMeansDenoising_0(long src_nativeObj, long dst_nativeObj,
            long h_mat_nativeObj, int templateWindowSize, int searchWindowSize, int normType);
    ...
    private static native void fastNlMeansDenoisingMulti_2(long srcImgs_mat_nativeObj,
            long dst_nativeObj, int imgToDenoiseIndex, int temporalWindowSize, long h_mat_nativeObj,
    ...
    // C++:  Ptr_TonemapDurand createTonemapDurand(float gamma = 1.0f, float contrast = 4.0f, float saturation = 1.0f, float sigma_space = 2.0f, float sigma_color = 2.0f)
    private static native long createTonemapDurand_0(float gamma, float contrast, float saturation,
            float sigma_space, float sigma_color);
    ...
    // C++:  void seamlessClone(Mat src, Mat dst, Mat mask, Point p, Mat& blend, int flags)
    private static native void seamlessClone_0(long src_nativeObj, long dst_nativeObj,
            long mask_nativeObj, double p_x, double p_y, long blend_nativeObj, int flags);

    // C++:  void colorChange(Mat src, Mat mask, Mat& dst, float red_mul = 1.0f, float green_mul = 1.0f, float blue_mul = 1.0f)
    private static native void colorChange_0(long src_nativeObj, long mask_nativeObj,
            long dst_nativeObj, float red_mul, float green_mul, float blue_mul);
    ...
    // C++:  void textureFlattening(Mat src, Mat mask, Mat& dst, float low_threshold = 30, float high_threshold = 45, int kernel_size = 3)
    private static native void textureFlattening_0(long src_nativeObj, long mask_nativeObj,
            long dst_nativeObj, float low_threshold, float high_threshold, int kernel_size);

    private static native void textureFlattening_1(long src_nativeObj, long mask_nativeObj,
            long dst_nativeObj);
    ...
    // C++:  void pencilSketch(Mat src, Mat& dst1, Mat& dst2, float sigma_s = 60, float sigma_r = 0.07f, float shade_factor = 0.02f)
    private static native void pencilSketch_0(long src_nativeObj, long dst1_nativeObj,
            long dst2_nativeObj, float sigma_s, float sigma_r, float shade_factor);

    private static native void pencilSketch_1(long src_nativeObj, long dst1_nativeObj,
            long dst2_nativeObj);
