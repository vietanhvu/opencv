...
public class Imgproc {
    ...
    public static final int LINE_AA = 16, LINE_8 = 8, LINE_4 = 4, CV_BLUR_NO_SCALE = 0, CV_BLUR = 1,
            ...
            CV_MAX_SOBEL_KSIZE = 7, CV_RGBA2mRGBA = 125, CV_mRGBA2RGBA = 126,
            CV_WARP_FILL_OUTLIERS = 8, CV_WARP_INVERSE_MAP = 16, CV_SHAPE_RECT = 0, CV_SHAPE_CROSS =
            1, CV_SHAPE_ELLIPSE = 2, CV_SHAPE_CUSTOM = 100, CV_CHAIN_CODE = 0, CV_LINK_RUNS = 5,
            CV_POLY_APPROX_DP = 0, CV_CONTOURS_MATCH_I1 = 1, CV_CONTOURS_MATCH_I2 = 2,
            CV_CONTOURS_MATCH_I3 = 3, CV_CLOCKWISE = 1, CV_COUNTER_CLOCKWISE = 2, CV_COMP_CORREL =
            0, CV_COMP_CHISQR = 1, CV_COMP_INTERSECT = 2, CV_COMP_BHATTACHARYYA = 3,
            CV_COMP_HELLINGER = CV_COMP_BHATTACHARYYA, CV_COMP_CHISQR_ALT = 4, CV_COMP_KL_DIV = 5,
            CV_DIST_MASK_3 = 3, CV_DIST_MASK_5 = 5, CV_DIST_MASK_PRECISE = 0, CV_DIST_LABEL_CCOMP =
            0, CV_DIST_LABEL_PIXEL = 1, CV_DIST_USER = -1, CV_DIST_L1 = 1, CV_DIST_L2 = 2,
            ...
            CV_HOUGH_MULTI_SCALE = 2, CV_HOUGH_GRADIENT = 3, MORPH_ERODE = 0, MORPH_DILATE = 1,
            MORPH_OPEN = 2, MORPH_CLOSE = 3, MORPH_GRADIENT = 4, MORPH_TOPHAT = 5, MORPH_BLACKHAT =
            6, MORPH_RECT = 0, MORPH_CROSS = 1, MORPH_ELLIPSE = 2, INTER_NEAREST = 0, INTER_LINEAR =
            1, INTER_CUBIC = 2, INTER_AREA = 3, INTER_LANCZOS4 = 4, INTER_MAX = 7,
            WARP_FILL_OUTLIERS = 8, WARP_INVERSE_MAP = 16, INTER_BITS = 5, INTER_BITS2 =
            INTER_BITS * 2, INTER_TAB_SIZE = 1 << INTER_BITS, INTER_TAB_SIZE2 =
            INTER_TAB_SIZE * INTER_TAB_SIZE, DIST_USER = -1, DIST_L1 = 1, DIST_L2 = 2, DIST_C = 3,
            DIST_L12 = 4, DIST_FAIR = 5, DIST_WELSCH = 6, DIST_HUBER = 7, DIST_MASK_3 = 3,
            DIST_MASK_5 = 5, DIST_MASK_PRECISE = 0, THRESH_BINARY = 0, THRESH_BINARY_INV = 1,
            THRESH_TRUNC = 2, THRESH_TOZERO = 3, THRESH_TOZERO_INV = 4, THRESH_MASK = 7,
            THRESH_OTSU = 8, THRESH_TRIANGLE = 16, ADAPTIVE_THRESH_MEAN_C = 0,
            ...
            FLOODFILL_FIXED_RANGE = 1 << 16, FLOODFILL_MASK_ONLY = 1 << 17, CC_STAT_LEFT = 0,
            CC_STAT_TOP = 1, CC_STAT_WIDTH = 2, CC_STAT_HEIGHT = 3, CC_STAT_AREA = 4, CC_STAT_MAX =
            5, RETR_EXTERNAL = 0, RETR_LIST = 1, RETR_CCOMP = 2, RETR_TREE = 3, RETR_FLOODFILL = 4,
            CHAIN_APPROX_NONE = 1, CHAIN_APPROX_SIMPLE = 2, CHAIN_APPROX_TC89_L1 = 3,
            CHAIN_APPROX_TC89_KCOS = 4, HOUGH_STANDARD = 0, HOUGH_PROBABILISTIC = 1,
            HOUGH_MULTI_SCALE = 2, HOUGH_GRADIENT = 3, LSD_REFINE_NONE = 0, LSD_REFINE_STD = 1,
            LSD_REFINE_ADV = 2, HISTCMP_CORREL = 0, HISTCMP_CHISQR = 1, HISTCMP_INTERSECT = 2,
            HISTCMP_BHATTACHARYYA = 3, HISTCMP_HELLINGER = HISTCMP_BHATTACHARYYA,
            HISTCMP_CHISQR_ALT = 4, HISTCMP_KL_DIV = 5, COLOR_BGR2BGRA = 0, COLOR_RGB2RGBA =
            COLOR_BGR2BGRA, COLOR_BGRA2BGR = 1, COLOR_RGBA2RGB = COLOR_BGRA2BGR, COLOR_BGR2RGBA = 2,
            COLOR_RGB2BGRA = COLOR_BGR2RGBA, COLOR_RGBA2BGR = 3, COLOR_BGRA2RGB = COLOR_RGBA2BGR,
            COLOR_BGR2RGB = 4, COLOR_RGB2BGR = COLOR_BGR2RGB, COLOR_BGRA2RGBA = 5, COLOR_RGBA2BGRA =
            COLOR_BGRA2RGBA, COLOR_BGR2GRAY = 6, COLOR_RGB2GRAY = 7, COLOR_GRAY2BGR = 8,
            COLOR_GRAY2RGB = COLOR_GRAY2BGR, COLOR_GRAY2BGRA = 9, COLOR_GRAY2RGBA = COLOR_GRAY2BGRA,
            COLOR_BGRA2GRAY = 10, COLOR_RGBA2GRAY = 11, COLOR_BGR2BGR565 = 12, COLOR_RGB2BGR565 =
            13, COLOR_BGR5652BGR = 14, COLOR_BGR5652RGB = 15, COLOR_BGRA2BGR565 = 16,
            ...
            COLOR_RGB2BGR555 = 23, COLOR_BGR5552BGR = 24, COLOR_BGR5552RGB = 25, COLOR_BGRA2BGR555 =
            26, COLOR_RGBA2BGR555 = 27, COLOR_BGR5552BGRA = 28, COLOR_BGR5552RGBA = 29,
            COLOR_GRAY2BGR555 = 30, COLOR_BGR5552GRAY = 31, COLOR_BGR2XYZ = 32, COLOR_RGB2XYZ = 33,
            COLOR_XYZ2BGR = 34, COLOR_XYZ2RGB = 35, COLOR_BGR2YCrCb = 36, COLOR_RGB2YCrCb = 37,
            COLOR_YCrCb2BGR = 38, COLOR_YCrCb2RGB = 39, COLOR_BGR2HSV = 40, COLOR_RGB2HSV = 41,
            COLOR_BGR2Lab = 44, COLOR_RGB2Lab = 45, COLOR_BGR2Luv = 50, COLOR_RGB2Luv = 51,
            COLOR_BGR2HLS = 52, COLOR_RGB2HLS = 53, COLOR_HSV2BGR = 54, COLOR_HSV2RGB = 55,
            COLOR_Lab2BGR = 56, COLOR_Lab2RGB = 57, COLOR_Luv2BGR = 58, COLOR_Luv2RGB = 59,
            COLOR_HLS2BGR = 60, COLOR_HLS2RGB = 61, COLOR_BGR2HSV_FULL = 66, COLOR_RGB2HSV_FULL =
            ...
            COLOR_YUV2BGRA_IYUV = 105, COLOR_YUV2RGBA_I420 = COLOR_YUV2RGBA_IYUV,
            ...
            COLOR_YUV420p2GRAY = COLOR_YUV2GRAY_420, COLOR_YUV2RGB_UYVY = 107, COLOR_YUV2BGR_UYVY =
            108, COLOR_YUV2RGB_Y422 = COLOR_YUV2RGB_UYVY, COLOR_YUV2BGR_Y422 = COLOR_YUV2BGR_UYVY,
            COLOR_YUV2RGB_UYNV = COLOR_YUV2RGB_UYVY, COLOR_YUV2BGR_UYNV = COLOR_YUV2BGR_UYVY,
            COLOR_YUV2RGBA_UYVY = 111, COLOR_YUV2BGRA_UYVY = 112, COLOR_YUV2RGBA_Y422 =
            COLOR_YUV2RGBA_UYVY, COLOR_YUV2BGRA_Y422 = COLOR_YUV2BGRA_UYVY, COLOR_YUV2RGBA_UYNV =
            COLOR_YUV2RGBA_UYVY, COLOR_YUV2BGRA_UYNV = COLOR_YUV2BGRA_UYVY, COLOR_YUV2RGB_YUY2 =
            115, COLOR_YUV2BGR_YUY2 = 116, COLOR_YUV2RGB_YVYU = 117, COLOR_YUV2BGR_YVYU = 118,
            ...
            COLOR_YUV2RGBA_YUY2 = 119, COLOR_YUV2BGRA_YUY2 = 120, COLOR_YUV2RGBA_YVYU = 121,
            COLOR_YUV2BGRA_YVYU = 122, COLOR_YUV2RGBA_YUYV = COLOR_YUV2RGBA_YUY2,
            ...
            COLOR_YUV2GRAY_YUY2 = 124, COLOR_YUV2GRAY_Y422 = COLOR_YUV2GRAY_UYVY,
            ...
            COLOR_RGBA2mRGBA = 125, COLOR_mRGBA2RGBA = 126, COLOR_RGB2YUV_I420 = 127,
            COLOR_BGR2YUV_I420 = 128, COLOR_RGB2YUV_IYUV = COLOR_RGB2YUV_I420, COLOR_BGR2YUV_IYUV =
            COLOR_BGR2YUV_I420, COLOR_RGBA2YUV_I420 = 129, COLOR_BGRA2YUV_I420 = 130,
            ...
            COLOR_BayerRG2BGR = 48, COLOR_BayerGR2BGR = 49, COLOR_BayerBG2RGB = COLOR_BayerRG2BGR,
            COLOR_BayerGB2RGB = COLOR_BayerGR2BGR, COLOR_BayerRG2RGB = COLOR_BayerBG2BGR,
            COLOR_BayerGR2RGB = COLOR_BayerGB2BGR, COLOR_BayerBG2GRAY = 86, COLOR_BayerGB2GRAY = 87,
            COLOR_BayerRG2GRAY = 88, COLOR_BayerGR2GRAY = 89, COLOR_BayerBG2BGR_VNG = 62,
            ...
            COLOR_BayerGR2RGB_VNG = COLOR_BayerGB2BGR_VNG, COLOR_BayerBG2BGR_EA = 135,
            COLOR_BayerGB2BGR_EA = 136, COLOR_BayerRG2BGR_EA = 137, COLOR_BayerGR2BGR_EA = 138,
            COLOR_BayerBG2RGB_EA = COLOR_BayerRG2BGR_EA, COLOR_BayerGB2RGB_EA =
            COLOR_BayerGR2BGR_EA, COLOR_BayerRG2RGB_EA = COLOR_BayerBG2BGR_EA,
            COLOR_BayerGR2RGB_EA = COLOR_BayerGB2BGR_EA, COLOR_COLORCVT_MAX = 139, INTERSECT_NONE =
            0, INTERSECT_PARTIAL = 1, INTERSECT_FULL = 2, TM_SQDIFF = 0, TM_SQDIFF_NORMED = 1,
    ...
    private static final int IPL_BORDER_CONSTANT = 0, IPL_BORDER_REPLICATE = 1, IPL_BORDER_REFLECT =
            ...
            CV_INTER_LANCZOS4 = 4, CV_MOP_ERODE = 0, CV_MOP_DILATE = 1, CV_MOP_OPEN = 2,
            CV_MOP_CLOSE = 3, CV_MOP_GRADIENT = 4, CV_MOP_TOPHAT = 5, CV_MOP_BLACKHAT = 6,
            ...
            CV_THRESH_BINARY_INV = 1, CV_THRESH_TRUNC = 2, CV_THRESH_TOZERO = 3,
            CV_THRESH_TOZERO_INV = 4, CV_THRESH_MASK = 7, CV_THRESH_OTSU = 8, CV_THRESH_TRIANGLE =
            16;
    ...
    public static void ellipse(Mat img, RotatedRect box, Scalar color, int thickness,
        ...
        ellipse_0(img.nativeObj, box.center.x, box.center.y, box.size.width, box.size.height,
    ...
    public static void ellipse(Mat img, RotatedRect box, Scalar color, int thickness) {
        ...
        ellipse_1(img.nativeObj, box.center.x, box.center.y, box.size.width, box.size.height,
                box.angle, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
    }
    ...
    public static void ellipse(Mat img, RotatedRect box, Scalar color) {
        ...
        ellipse_2(img.nativeObj, box.center.x, box.center.y, box.size.width, box.size.height,
    ...
    public static void fillConvexPoly(Mat img, MatOfPoint points, Scalar color, int lineType,
            int shift) {
        fillConvexPoly_0(img.nativeObj, points.nativeObj, color.val[0], color.val[1], color.val[2],
    ...
    public static void fillConvexPoly(Mat img, MatOfPoint points, Scalar color) {
        fillConvexPoly_1(img.nativeObj, points.nativeObj, color.val[0], color.val[1], color.val[2],
                color.val[3]);
    }
    ...
    public static boolean clipLine(Rect imgRect, Point pt1, Point pt2) {
        ...
        boolean retVal =
                clipLine_0(imgRect.x, imgRect.y, imgRect.width, imgRect.height, pt1.x, pt1.y,
                        pt1_out, pt2.x, pt2.y, pt2_out);
        pt1.x = pt1_out[0];
        pt1.y = pt1_out[1];
        pt2.x = pt2_out[0];
        pt2.y = pt2_out[1];
    ...
    public static LineSegmentDetector createLineSegmentDetector(int _refine, double _scale,
            double _sigma_scale, double _quant, double _ang_th, double _log_eps, double _density_th,
            int _n_bins) {

        return new LineSegmentDetector(
                createLineSegmentDetector_0(_refine, _scale, _sigma_scale, _quant, _ang_th,
    ...
    public static Mat getGaborKernel(Size ksize, double sigma, double theta, double lambd,
        ...
        return new Mat(getGaborKernel_0(ksize.width, ksize.height, sigma, theta, lambd, gamma, psi,
                ktype));
    }
    ...
    public static Mat getStructuringElement(int shape, Size ksize, Point anchor) {
        ...
        return new Mat(
                getStructuringElement_0(shape, ksize.width, ksize.height, anchor.x, anchor.y));
    }
    ...
    public static void sqrBoxFilter(Mat _src, Mat _dst, int ddepth, Size ksize, Point anchor,
        ...
        sqrBoxFilter_0(_src.nativeObj, _dst.nativeObj, ddepth, ksize.width, ksize.height, anchor.x,
                anchor.y, normalize, borderType);
    }
    ...
    public static void sqrBoxFilter(Mat _src, Mat _dst, int ddepth, Size ksize, Point anchor,
        ...
        sqrBoxFilter_1(_src.nativeObj, _dst.nativeObj, ddepth, ksize.width, ksize.height, anchor.x,
                anchor.y, normalize);
    }
    ...
    public static void cornerSubPix(Mat image, MatOfPoint2f corners, Size winSize, Size zeroZone,
        ...
        cornerSubPix_0(image.nativeObj, corners.nativeObj, winSize.width, winSize.height,
                zeroZone.width, zeroZone.height, criteria.type, criteria.maxCount,
                criteria.epsilon);
    }
    ...
    public static void goodFeaturesToTrack(Mat image, MatOfPoint corners, int maxCorners,
            double qualityLevel, double minDistance, Mat mask, int blockSize,
            boolean useHarrisDetector, double k) {
        goodFeaturesToTrack_0(image.nativeObj, corners.nativeObj, maxCorners, qualityLevel,
    ...
    public static void goodFeaturesToTrack(Mat image, MatOfPoint corners, int maxCorners,
        ...
        goodFeaturesToTrack_1(image.nativeObj, corners.nativeObj, maxCorners, qualityLevel,
                minDistance);
    }
    ...
    public static void HoughLines(Mat image, Mat lines, double rho, double theta, int threshold,
        ...
        HoughLines_0(image.nativeObj, lines.nativeObj, rho, theta, threshold, srn, stn, min_theta,
                max_theta);
    }
    ...
    public static float initWideAngleProjMap(Mat cameraMatrix, Mat distCoeffs, Size imageSize,
        ...
        return initWideAngleProjMap_0(cameraMatrix.nativeObj, distCoeffs.nativeObj, imageSize.width,
    ...
    public static float initWideAngleProjMap(Mat cameraMatrix, Mat distCoeffs, Size imageSize,
        ...
        return initWideAngleProjMap_1(cameraMatrix.nativeObj, distCoeffs.nativeObj, imageSize.width,
    ...
    public static Point phaseCorrelate(Mat src1, Mat src2, Mat window, double[] response) {
        ...
        Point retVal = new Point(
                phaseCorrelate_0(src1.nativeObj, src2.nativeObj, window.nativeObj, response_out));
    ...
    public static void undistortPoints(MatOfPoint2f src, MatOfPoint2f dst, Mat cameraMatrix,
        ...
        undistortPoints_0(src.nativeObj, dst.nativeObj, cameraMatrix.nativeObj,
    ...
    public static void undistortPoints(MatOfPoint2f src, MatOfPoint2f dst, Mat cameraMatrix,
            Mat distCoeffs) {
        undistortPoints_1(src.nativeObj, dst.nativeObj, cameraMatrix.nativeObj,
    ...
    public static void calcHist(List<Mat> images, MatOfInt channels, Mat mask, Mat hist,
        ...
        calcHist_0(images_mat.nativeObj, channels.nativeObj, mask.nativeObj, hist.nativeObj,
                histSize.nativeObj, ranges.nativeObj, accumulate);
    }
    ...
    public static void calcHist(List<Mat> images, MatOfInt channels, Mat mask, Mat hist,
        ...
        Mat images_mat = Converters.vector_Mat_to_Mat(images);
        calcHist_1(images_mat.nativeObj, channels.nativeObj, mask.nativeObj, hist.nativeObj,
                histSize.nativeObj, ranges.nativeObj);
    }
    ...
    public static void calcBackProject(List<Mat> images, MatOfInt channels, Mat hist, Mat dst,
        ...
        Mat images_mat = Converters.vector_Mat_to_Mat(images);
        calcBackProject_0(images_mat.nativeObj, channels.nativeObj, hist.nativeObj, dst.nativeObj,
                ranges.nativeObj, scale);
    }
    ...
    public static int floodFill(Mat image, Mat mask, Point seedPoint, Scalar newVal, Rect rect,
        ...
        int retVal = floodFill_0(image.nativeObj, mask.nativeObj, seedPoint.x, seedPoint.y,
                newVal.val[0], newVal.val[1], newVal.val[2], newVal.val[3], rect_out, loDiff.val[0],
                loDiff.val[1], loDiff.val[2], loDiff.val[3], upDiff.val[0], upDiff.val[1],
                upDiff.val[2], upDiff.val[3], flags);
        if (rect != null) {
    ...
    public static int floodFill(Mat image, Mat mask, Point seedPoint, Scalar newVal) {
        ...
        return floodFill_1(image.nativeObj, mask.nativeObj, seedPoint.x, seedPoint.y, newVal.val[0],
    ...
    public static int connectedComponentsWithStats(Mat image, Mat labels, Mat stats, Mat centroids,
        ...
        return connectedComponentsWithStats_0(image.nativeObj, labels.nativeObj, stats.nativeObj,
    ...
    public static int connectedComponentsWithStats(Mat image, Mat labels, Mat stats,
        ...
        return connectedComponentsWithStats_1(image.nativeObj, labels.nativeObj, stats.nativeObj,
                centroids.nativeObj);
    }
    ...
    public static void boxPoints(RotatedRect box, Mat points) {
        ...
        boxPoints_0(box.center.x, box.center.y, box.size.width, box.size.height, box.angle,
                points.nativeObj);
    }
    ...
    public static int rotatedRectangleIntersection(RotatedRect rect1, RotatedRect rect2,
        ...
        return rotatedRectangleIntersection_0(rect1.center.x, rect1.center.y, rect1.size.width,
                rect1.size.height, rect1.angle, rect2.center.x, rect2.center.y, rect2.size.width,
                rect2.size.height, rect2.angle, intersectingRegion.nativeObj);
    }
    ...
    public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle,
        ...
        ellipse_3(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle,
    ...
    public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle,
        ...
        ellipse_4(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle,
                endAngle, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
    }
    ...
    public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle,
        ...
        ellipse_5(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle,
    ...
    private static native void ellipse2Poly_0(double center_x, double center_y, double axes_width,
            double axes_height, int angle, int arcStart, int arcEnd, int delta,
    ...
    // C++:  void ellipse(Mat& img, RotatedRect box, Scalar color, int thickness = 1, int lineType = LINE_8)
    private static native void ellipse_0(long img_nativeObj, double box_center_x,
    ...
    private static native void ellipse_1(long img_nativeObj, double box_center_x,
            double box_center_y, double box_size_width, double box_size_height, double box_angle,
            double color_val0, double color_val1, double color_val2, double color_val3,
            int thickness);

    private static native void ellipse_2(long img_nativeObj, double box_center_x,
            double box_center_y, double box_size_width, double box_size_height, double box_angle,
            double color_val0, double color_val1, double color_val2, double color_val3);
    ...
    private static native void fillPoly_0(long img_nativeObj, long pts_mat_nativeObj,
            double color_val0, double color_val1, double color_val2, double color_val3,
            int lineType, int shift, double offset_x, double offset_y);
    ...
    private static native void drawContours_0(long image_nativeObj, long contours_mat_nativeObj,
            int contourIdx, double color_val0, double color_val1, double color_val2,
            double color_val3, int thickness, int lineType, long hierarchy_nativeObj, int maxLevel,
    ...
    private static native void cornerSubPix_0(long image_nativeObj, long corners_mat_nativeObj,
            double winSize_width, double winSize_height, double zeroZone_width,
            double zeroZone_height, int criteria_type, int criteria_maxCount,
    ...
    // C++:  void linearPolar(Mat src, Mat& dst, Point2f center, double maxRadius, int flags)
    private static native void linearPolar_0(long src_nativeObj, long dst_nativeObj,
            double center_x, double center_y, double maxRadius, int flags);
    ...
    private static native void integral2_0(long src_nativeObj, long sum_nativeObj,
            long sqsum_nativeObj, int sdepth, int sqdepth);
    ...
    private static native void integral3_0(long src_nativeObj, long sum_nativeObj,
            long sqsum_nativeObj, long tilted_nativeObj, int sdepth, int sqdepth);
    ...
    private static native void distanceTransform_1(long src_nativeObj, long dst_nativeObj,
    ...
    // C++:  void demosaicing(Mat _src, Mat& _dst, int code, int dcn = 0)
    private static native void demosaicing_0(long _src_nativeObj, long _dst_nativeObj, int code,
            int dcn);
    ...
    private static native int connectedComponentsWithStats_0(long image_nativeObj,
            long labels_nativeObj, long stats_nativeObj, long centroids_nativeObj, int connectivity,
            int ltype);

    private static native int connectedComponentsWithStats_1(long image_nativeObj,
            long labels_nativeObj, long stats_nativeObj, long centroids_nativeObj);
    ...
    // C++:  void boxPoints(RotatedRect box, Mat& points)
    private static native void boxPoints_0(double box_center_x, double box_center_y,
            double box_size_width, double box_size_height, double box_angle, long points_nativeObj);
    ...
    // C++:  double minEnclosingTriangle(Mat points, Mat& triangle)
    private static native double minEnclosingTriangle_0(long points_nativeObj,
            long triangle_nativeObj);
    ...
    private static native int rotatedRectangleIntersection_0(double rect1_center_x,
            double rect1_center_y, double rect1_size_width, double rect1_size_height,
            double rect1_angle, double rect2_center_x, double rect2_center_y,
            double rect2_size_width, double rect2_size_height, double rect2_angle,
    ...
    private static native void line_0(long img_nativeObj, double pt1_x, double pt1_y, double pt2_x,
            double pt2_y, double color_val0, double color_val1, double color_val2,
            double color_val3, int thickness, int lineType, int shift);
    ...
    private static native void ellipse_4(long img_nativeObj, double center_x, double center_y,
            double axes_width, double axes_height, double angle, double startAngle, double endAngle,
            double color_val0, double color_val1, double color_val2, double color_val3,
            int thickness);

    private static native void ellipse_5(long img_nativeObj, double center_x, double center_y,
            double axes_width, double axes_height, double angle, double startAngle, double endAngle,
            double color_val0, double color_val1, double color_val2, double color_val3);
