...
public class Subdiv2D {
    ...
    public static final int PTLOC_ERROR = -2, PTLOC_OUTSIDE_RECT = -1, PTLOC_INSIDE = 0,
            ...
            PREV_AROUND_ORG = 0x11, PREV_AROUND_DST = 0x33, NEXT_AROUND_LEFT = 0x13,
            NEXT_AROUND_RIGHT = 0x31, PREV_AROUND_LEFT = 0x20, PREV_AROUND_RIGHT = 0x02;
    ...
    public void getVoronoiFacetList(MatOfInt idx, List<MatOfPoint2f> facetList,
        ...
        getVoronoiFacetList_0(nativeObj, idx.nativeObj, facetList_mat.nativeObj,
                facetCenters.nativeObj);
