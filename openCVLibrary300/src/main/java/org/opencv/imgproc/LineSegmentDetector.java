...
public class LineSegmentDetector extends Algorithm {
    ...
    private static native void detect_0(long nativeObj, long _image_nativeObj,
            long _lines_nativeObj, long width_nativeObj, long prec_nativeObj, long nfa_nativeObj);
    ...
    private static native int compareSegments_0(long nativeObj, double size_width,
            double size_height, long lines1_nativeObj, long lines2_nativeObj,
    ...
    public void detect(Mat _image, Mat _lines, Mat width, Mat prec, Mat nfa) {
        ...
        detect_0(nativeObj, _image.nativeObj, _lines.nativeObj, width.nativeObj, prec.nativeObj,
                nfa.nativeObj);
    }
    ...
    public int compareSegments(Size size, Mat lines1, Mat lines2, Mat _image) {
        ...
        return compareSegments_0(nativeObj, size.width, size.height, lines1.nativeObj,
                lines2.nativeObj, _image.nativeObj);
    }

    //javadoc: LineSegmentDetector::compareSegments(size, lines1, lines2)
    public int compareSegments(Size size, Mat lines1, Mat lines2) {

        return compareSegments_1(nativeObj, size.width, size.height, lines1.nativeObj,
                lines2.nativeObj);
    }
