...
public class Imgcodecs {
    ...
    public static final int CV_LOAD_IMAGE_UNCHANGED = -1, CV_LOAD_IMAGE_GRAYSCALE = 0,
            CV_LOAD_IMAGE_COLOR = 1, CV_LOAD_IMAGE_ANYDEPTH = 2, CV_LOAD_IMAGE_ANYCOLOR = 4,
            CV_IMWRITE_JPEG_QUALITY = 1, CV_IMWRITE_JPEG_PROGRESSIVE = 2, CV_IMWRITE_JPEG_OPTIMIZE =
            3, CV_IMWRITE_JPEG_RST_INTERVAL = 4, CV_IMWRITE_JPEG_LUMA_QUALITY = 5,
            CV_IMWRITE_JPEG_CHROMA_QUALITY = 6, CV_IMWRITE_PNG_COMPRESSION = 16,
            CV_IMWRITE_PNG_STRATEGY = 17, CV_IMWRITE_PNG_BILEVEL = 18,
            ...
            CV_IMWRITE_PNG_STRATEGY_FIXED = 4, CV_IMWRITE_PXM_BINARY = 32, CV_IMWRITE_WEBP_QUALITY =
            64, CV_CVTIMG_FLIP = 1, CV_CVTIMG_SWAP_RB = 2, IMREAD_UNCHANGED = -1, IMREAD_GRAYSCALE =
            0, IMREAD_COLOR = 1, IMREAD_ANYDEPTH = 2, IMREAD_ANYCOLOR = 4, IMREAD_LOAD_GDAL = 8,
            ...
            IMWRITE_JPEG_CHROMA_QUALITY = 6, IMWRITE_PNG_COMPRESSION = 16, IMWRITE_PNG_STRATEGY =
            17, IMWRITE_PNG_BILEVEL = 18, IMWRITE_PXM_BINARY = 32, IMWRITE_WEBP_QUALITY = 64,
    ...
    public static boolean imreadmulti(String filename, List<Mat> mats, int flags) {
        ...
        return imreadmulti_0(filename, mats_mat.nativeObj, flags);
    }
    ...
    public static boolean imreadmulti(String filename, List<Mat> mats) {
        ...
        return imreadmulti_1(filename, mats_mat.nativeObj);
    }
    ...
    // C++:  bool imreadmulti(String filename, vector_Mat mats, int flags = IMREAD_ANYCOLOR)
    private static native boolean imreadmulti_0(String filename, long mats_mat_nativeObj,
            int flags);
