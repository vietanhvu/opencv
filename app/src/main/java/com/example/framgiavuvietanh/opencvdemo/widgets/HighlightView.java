...
import com.example.framgiavuvietanh.opencvdemo.R;
...
public class HighlightView {
    ...
    public HighlightView(ImageView ctx, Rect imageRect, List<Point> cropRect) {
        mContext = ctx;
        final int progressColor = mContext.getResources().getColor(R.color.blue);
        mCropCornerHandleRadius =
                mContext.getResources().getDimensionPixelSize(R.dimen.crop_handle_corner_radius);
        mCropEdgeHandleRadius =
                mContext.getResources().getDimensionPixelSize(R.dimen.crop_handle_edge_radius);
        mHysteresis = mContext.getResources().getDimensionPixelSize(R.dimen.polygonViewCircleWidth);
        final int edgeWidth =
                mContext.getResources().getDimensionPixelSize(R.dimen.crop_edge_width);
